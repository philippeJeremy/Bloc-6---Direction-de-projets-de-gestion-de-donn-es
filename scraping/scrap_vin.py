...
class QuotesSpider1(scrapy.Spider):
    ...
    for i in target:
        urls.append(
            f"https://www.quelvin.com/rechacccrus.asp?Plat={i}&C=+Plat%2ENomSA+like+%27%25poulet%25%27&Lien=0&Tri=&Ordre=")
    ...
    def parse(self, response):
        ...
        target = response.xpath(
            '//*[@id="wrap"]/div/div/div/div/div[1]/section[2]/div[1]/h1/b/text()').get()
